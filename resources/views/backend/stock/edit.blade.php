...
@section('content')
    {{ Form::model($stock, ['route' => ['admin.stock.update', $stock], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-Stock']) }}
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        ...
                        {{ Form::text('name', $name, ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'readonly' => 'true']) }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        {{ Form::text('quantity', old('quantity'), ['class' => 'form-control', 'maxlength' => '191', 'required' => 'required', 'readonly' => 'true']) }}
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-4">
                        {{ Form::select('status', ['EXPIRE' => 'EXPIRE', 'SPOIL' => 'SPOIL'], old('status'), ['class' => 'form-control', 'required' => 'required']) }}
                    </div>
                </div>
